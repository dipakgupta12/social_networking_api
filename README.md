...
#### CI config file can be found in .circleci/config.yml. For each commit in **mail** branch CI will trigger at [circleci](https://app.circleci.com/pipelines/github/dipakgupta12/social_networking_api?branch=main). Deployed on heroku : https://test-app-for-django.herokuapp.com/.
